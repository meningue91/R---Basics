...
### Conclusion
The results show a negative association between the Gini Index and GDP per capita, meaning that higher-income countries have lower inequality; this is confirmed by the regression coefficient of the log GDP per capita and the Gini Index. It is important to note that the Gini Index data received more linear imputations, since this indicator is more difficult to obtain; even so, the results of the simple linear regression were very similar for the model without imputation and the one with linear imputation. [For more details about imputation methods]([https://pages.github.com/](https://arxiv.org/abs/1510.03924))   
